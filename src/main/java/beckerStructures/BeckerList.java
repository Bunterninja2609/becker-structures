...
public class BeckerList<ContentType> {
    ...
    protected class ListNode {
        ...
        protected ContentType contentObject;
        ...
        /**
         * Der Vorfahreknoten wird zurueckgeliefert.
         *
         * @return das Objekt, auf das der aktuelle Verweis zeigt
         */
        public ListNode getPreviousNode(){return this.previous;}
        /**
         * Der Verweis wird auf das Objekt, das als Parameter uebergeben
         * wird, gesetzt.
         *
         * @param pPrevious der Vorfahre des Knotens
         */
     ...
     * Falls die Liste nicht leer ist, es ein aktuelles Objekt gibt und dieses
     * nicht das letzte Objekt der Liste ist, wird das dem aktuellen Objekt in
     * der Liste vorherige Objekt zum aktuellen Objekt, andernfalls gibt es nach
     * Ausfuehrung des Auftrags kein aktuelles Objekt, d.h. hasAccess() liefert
     * den Wert false.
     */
     ...
     */
    public void concat(BeckerList<ContentType> pList) {
        if (pList != this && pList != null && !pList.isEmpty()) { // Nichts tun,
            ...
            if (this.isEmpty()) { // Fall: An leere Liste anfuegen.
                ...
                this.last = pList.last;
                this.length = this.length + pList.length;
            }
